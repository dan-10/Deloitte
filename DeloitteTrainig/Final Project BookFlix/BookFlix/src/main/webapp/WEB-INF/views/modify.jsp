...
<html>
	<head>
		...
		<title>BookFlix - Modify Book</title>
	...
	<body>
		<div class="grid-container">
			...
			<div class="AddBookForm">
				<center>
<%-- 					<c:url var="addAction" value="/api/modifyBook"></c:url> --%>
					<f:form action = "${addAction}" modelAttribute="book">
						<table width="80%">
							...
							<tr>
								<td colspan="2" align="center"><button type ="submit" value = "Add Book" class="butn" formaction="/api/modifyBook/${book.bookRef}">Modify</button></td>
							</tr>
							<tr>
